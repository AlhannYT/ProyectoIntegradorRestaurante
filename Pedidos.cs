...
namespace Proyecto_restaurante
{
    public partial class Pedidos : Form
    {
        ...
        private void txtbusquedafactura_Enter(object sender, EventArgs e)
        {
            ...
            if (txtbusquedafactura.Text == "(ID, ID Pedido, Cliente, Mesa, Total)")
            {
        ...
        private void tabladatosconsultaprod_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
